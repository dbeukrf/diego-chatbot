  ...
  return (
    <div className="terminal-container">
      <div className="terminal-header">
        <div className="terminal-title">🎭 AI DJ - Career Navigator & Talent Curator</div>
        ...
        {messages.map((message) => (
          <div key={message.id} className={`message ${message.type}`}>
            ...
            {message.type === 'response' && (
              <span className="response-prompt">🎭 AI DJ:</span>
            )}
            {message.type === 'system' && (
              <span className="system-prompt">System:</span>
            )}
